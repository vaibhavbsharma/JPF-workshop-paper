...
\end{tabular}
\end{table}
Table~\ref{table:results_size} shows the average size and Table~\ref{table:results_count} shows the number of times each such count was reported. 
