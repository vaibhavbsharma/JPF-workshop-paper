...
label={lst:v-ex}]{code_samples/VeritestingPerf.java}
...
%
We present an example demonstrating the potential benefit of integrating veritesting with SPF in Listing~\ref{lst:v-ex}.
%
...
\begin{figure}[]
\caption{Comparing number of execution paths from Listing~\ref{lst:v-ex} using vanilla SPF and SPF with static unrolling}
\label{fig:v_ex_plot}
